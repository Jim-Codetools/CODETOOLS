...
function calcSlabR() {
	...
	console.log(veneer);
	console.log(slabEdge);
	console.log(underSlab);
		...
		if (slabType === "100mm"){
			...
			if(veneer === "yes"){
				...
				if(slabEdge === 0 && underSlab === 0){
					...
					console.log("100mm V edge and under");
				...
				if(slabEdge === 0 && underSlab === 0){
					...
					console.log("100mm edge and under");
